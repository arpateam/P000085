...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Ups, Anda Menemukan 400 - <?= $nama_web ?></title>
    <meta name="title" content="Ups, Anda Menemukan 400 - <?= $nama_web ?>">
    ...
    <div class="container-fluid py-5 text-center">
    	<div class="row justify-content-center">
    		<div class="col-10 col-md-9 col-lg-6 col-xl-5">
        		<img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/www/assets/images/2022/arunika/img-404-arunika-1644462240.svg" alt="Gambar Halaman 400 <?= $nama_web ?>" class="img-fluid mb-5">
