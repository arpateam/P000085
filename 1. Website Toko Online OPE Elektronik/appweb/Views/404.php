...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Ups, Anda Menemukan 404 - <?= $nama_web ?></title>
    <meta name="title" content="Ups, Anda Menemukan 404 - <?= $nama_web ?>">
    <meta name="keywords" content="<?= $nama_web ?> - <?= $slogan ?>">
    <meta name="description" content="<?= $nama_web ?> - <?= $slogan ?>">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?= $short_url; ?>">
    <meta property="og:title" content="Ups, Anda Menemukan 404 - <?= $nama_web ?>">
    <meta property="og:description" content="<?= $nama_web ?> - <?= $slogan ?>">
    <meta property="og:image" content="<?= $base_url; ?>/<?= $judulLogoDesktop; ?>">
    <meta property="og:image:alt" content="Gambar Ups, Anda Menemukan 404 - <?= $nama_web ?>">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:site" content="<?= $nama_web; ?>" />
    <meta property="twitter:url" content="<?= $short_url; ?>">
    <meta property="twitter:title" content="Ups, Anda Menemukan 404 - <?= $nama_web ?>">
    <meta property="twitter:description" content="<?= $nama_web ?> - <?= $slogan ?>">
    ...
    <div class="container-fluid py-5 text-center">
    	<div class="row justify-content-center">
    		<div class="col-10 col-md-9 col-lg-6 col-xl-5">
        		<img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/www/assets/images/2022/arunika/img-404-arunika-1644462240.svg" alt="Gambar Halaman 404 <?= $nama_web ?>" class="img-fluid mb-5">
        		...
        		<a href="<?= $base_url ?>" title="Halaman Utama <?= $nama_web ?>" class="btn btn-warning rounded-pill">Kembali ke Halaman Utama</a>
    		</div>
    	</div>
    </div>
