                                                        ...
                                                        <form action="<?= $base_url_admin ?>/editPengaturan" method="POST" data-parsley-validate="" class="modal-content" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body row">
                                                                ...
                                                                <?php elseif ($result['jenis_pengaturan']==="Deskripsi"): ?>
                                                                    <div class="col-md-12 my-1">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="deskripsi" name="___in_deskripsi_special_ARPATEAM" placeholder="Cth: Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." value="<?= $result['deskripsi']; ?>" required="">
                                                                ...
                                                                <?php elseif ($result['jenis_pengaturan']==="Teks"): ?>
                                                                    <div class="col-md-12 my-1">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="deskripsi" name="___in_deskripsi_special_ARPATEAM" placeholder="Cth: 0816 9070 19" value="<?= $result['deskripsi']; ?>" required="">
                                                                ...
                                                                <?php elseif ($result['jenis_pengaturan']==="Textarea"): ?>
                                                                    <div class="col-md-12 my-1">
                                                                        <div class="form-floating">
                                                                            <textarea class="form-control" id="deskripsi" name="___in_deskripsi_special_ARPATEAM" placeholder="Cth: 0816 9070 19" style="height: 250px" required=""><?= $result['deskripsi'] ?></textarea>
                                                                            <label for="deskripsi">Masukkan <?= $result['judul'] ?></label>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input type="hidden" name="___in_id_pengaturan_special_ARPATEAM" value="<?= $result['id_pengaturan']; ?>">
                                                                <input type="hidden" name="___in_jenis_pengaturan_special_ARPATEAM" value="<?= $result['jenis_pengaturan']; ?>">
