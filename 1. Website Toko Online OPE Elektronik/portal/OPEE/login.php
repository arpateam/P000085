...
<head>
    <meta charset="utf-8" />
    <title>Login Portal Admin <?= $nama_web ?></title>
                    ...
                    <div class="card my-4">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-2">
                                ...
                                <img src="<?= $base_url; ?>/assets/files/images/<?= $logoMobile; ?>" alt="<?= $judulLogoMobile; ?>" class="w-50 mt-2">
                            </div>
                            ...
                            <form action="" method="POST" data-parsley-validate="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="username" name="___in_username" placeholder="Masukkan username anda..." required="">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="password" id="pass" name="___in_password" placeholder="Masukkan password anda..." required="">
                                </div>
