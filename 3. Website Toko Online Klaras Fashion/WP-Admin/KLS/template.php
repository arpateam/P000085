...
<head>
    ...
    <!-- Plugins CSS-->
        ...
        <!-- Blog, Pengaturan & Halaman -->
        <?php elseif (($_GET['module']==="blog") OR ($_GET['module']==="pengaturan") OR ($_GET['module']==="halaman")): ?>
            <link href="<?= $base_url_admin ?>/assets/libs/dropzone/min/dropzone.min.css" rel="stylesheet" type="text/css" />
            <link href="<?= $base_url_admin ?>/assets/libs/dropify/css/dropify.min.css" rel="stylesheet" type="text/css" />
        ...
        <!-- End Blog, Pengaturan & Halaman -->

        <!-- Karir -->
        <?php elseif ($_GET['module']==="karir"): ?>
            <link href="<?= $base_url_admin ?>/assets/libs/froala_editor_4.0.10/css/froala_editor.pkgd.min.css" rel="stylesheet" type="text/css" />
            <link href="<?= $base_url_admin ?>/assets/libs/froala_editor_4.0.10/css/themes/dark.min.css" rel="stylesheet" type="text/css" />
        ...
        <!-- Metode Pembayaran -->
        <?php elseif (($_GET['module']==="metode-pembayaran")): ?>
            <link href="<?= $base_url_admin ?>/assets/libs/dropzone/min/dropzone.min.css" rel="stylesheet" type="text/css" />
            <link href="<?= $base_url_admin ?>/assets/libs/dropify/css/dropify.min.css" rel="stylesheet" type="text/css" />
...
<body class="loading" data-layout='{"mode": "dark", "width": "fluid", "menuPosition": "fixed", "sidebar": { "color": "dark", "size": "default", "showuser": true}, "topbar": {"color": "dark"}, "showRightSidebarOnPageLoad": true}'>
    ...
    <!-- Plugins js-->
                ...
                new FroalaEditor('#myEditorFroala', {
                    ...
                    events: {
                        'image.removed': function ($img) {
                            ...
                            nw_file_nm      = file_nmx.replace("<?= $base_url; ?>/WP-Admin/KLS/appweb/Controllers../../../../../assets/files/others/HandleByFroala/", "");
                ...
                function confirmHapusProduk(enkripsi, slug) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location = "<?= $base_url_admin ?>/actionDeleteProduk/" + enkripsi + "/" + slug;
        ...
        <?php elseif (($_GET['module']==="blog") OR ($_GET['module']==="pengaturan") OR ($_GET['module']==="halaman")): ?>
            ...
            <script>
                function confirmHapusBlog(enkripsi) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Apakah anda yakin ingin menghapus Blog Artikel ini?',
                        text: "Blog Artikel yang telah terhapus tidak dapat dikembalikan lagi!",
                        showDenyButton: true,
                        confirmButtonText: 'Ya, Hapus Saja',
                        denyButtonText: 'Batal',
                    }).then((result) => {
                        /* Read more about isConfirmed, isDenied below */
                        if (result.isConfirmed) {
                            window.location = "<?= $base_url_admin ?>/actionDeleteBlog/" + enkripsi;
                        } else if (result.isDenied) {
                            Swal.fire('Blog Artikel tidak jadi di hapus', '', 'info')
                        }
                    })
                }
            </script>
        ...
        <?php elseif (($_GET['module']==="karir")): ?>
            ...
            <script>
                function confirmHapusKarir(enkripsi) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Apakah anda yakin ingin menghapus Karir ini?',
                        text: "Karir yang telah terhapus tidak dapat dikembalikan lagi!",
                        showDenyButton: true,
                        confirmButtonText: 'Ya, Hapus Saja',
                        denyButtonText: 'Batal',
                    }).then((result) => {
                        /* Read more about isConfirmed, isDenied below */
                        if (result.isConfirmed) {
                            window.location = "<?= $base_url_admin ?>/actionDeleteKarir/" + enkripsi;
                        } else if (result.isDenied) {
                            Swal.fire('Karir tidak jadi di hapus', '', 'info')
                        }
                    })
                }
            </script>
            ...
            <script>
                function confirmHapusSitemap(enkripsi, slug) {
                    Swal.fire({
                        ...
                        /* Read more about isConfirmed, isDenied below */
                        if (result.isConfirmed) {
                            window.location = "<?= $base_url_admin ?>/actionDeleteSitemap/" + enkripsi + "/" + slug;
                        } else if (result.isDenied) {
